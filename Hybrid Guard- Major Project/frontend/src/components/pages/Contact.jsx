                    ...
                    <div className="lg:w-2/3 md:w-1/2 bg-gray-200 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                        ...
                        <div className="bg-[#142F32] relative flex flex-wrap py-6 rounded shadow-md">
                            ...
                            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                                ...
                                <a className="text-stone-100 leading-relaxed">example@email.com</a>
                                <h2 className="title-font font-semibold text-white tracking-widest text-xs mt-4">PHONE</h2>
                                <p className="text-stone-100 leading-relaxed">123-456-7890</p>
                            </div>
                        </div>
                    </div>
                    <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full p-8 rounded mt-8 md:mt-0">
                        <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Share Your Feedback</h2>
                        <p className="leading-relaxed mb-5 text-gray-600">Your feedback helps us improve and provide a better experience for you! ✍️</p>
                        ...
                        <p className="text-xs text-gray-500 mt-3">Your feedback helps us improve and provide a better experience for you!</p>
                    </div>
                </div>
            </section>
